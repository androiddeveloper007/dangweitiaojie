...
public class Builder {
    ...
    int indicatorColor = Color.parseColor("#FF840D");
    ...
    int trackBackgroundColor = Color.parseColor("#D7D7D7");//#D7D7D7
    ...
    //thumb
    int thumbSize = 0;
    int thumbColor = Color.parseColor("#FF4081");//#FF840D
    ColorStateList thumbColorStateList = null;
    Drawable thumbDrawable = null;
    //tickTexts
    boolean showTickText = false;
    ...
    Builder(Context context) {
        ...
        this.indicatorTextSize = SizeUtils.dp2px(context, 11);
