...
public class IndicatorSeekBar extends View {
    ...
    private void initParams() {
        ...
        mCustomDrawableMaxHeight = Math.max(mThumbTouchRadius, mTickRadius) * 2.0f;//2
        initStrokePaint();
            ...
            if (mTickMarksDrawable != null) {
                ...
                if (i <= thumbPosFloat) {
                    ...
                    canvas.drawBitmap(mThumbBitmap,
                            mTickMarksX[i] - mThumbBitmap.getWidth() / 2.0f,
...
//                }
    ...
    String getIndicatorTextString() {
        ...
        return getThumbPosOnTick() + 1 + "档";//getProgressString(mProgress)
    }
...
//    }
    ...
    public void showIndicator(boolean b){
        if(mIndicatorContentView!=null){
            mIndicatorContentView.setVisibility(b? VISIBLE:INVISIBLE);
        }
    }
